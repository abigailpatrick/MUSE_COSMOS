#!/usr/bin/env python3
"""
Plot Lyα spectra with cutouts for each source (aperture 0p6 by default).
"""
...
def plot_panel(
    ...
    ax1 = ax.inset_axes([x0, y0, inset_w, inset_h])
    ...
    ax2 = ax.inset_axes([x0 + inset_w + inset_pad, y0, inset_w, inset_h])
    ...
    ax3 = ax.inset_axes([x0 + 2 * (inset_w + inset_pad), y0, inset_w, inset_h])
